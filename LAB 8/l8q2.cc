...
int main (int argc, char *argv[])
{
  ...
  positionAlloc->Add (Vector (1.0, 9.0, 0.0));
  positionAlloc->Add (Vector (2.0, 8.0, 0.0));
  positionAlloc->Add (Vector (3.0, 7.0, 0.0));
  positionAlloc->Add (Vector (4.0, 6.0, 0.0));
  positionAlloc->Add (Vector (5.0, 5.0, 0.0));
  positionAlloc->Add (Vector (6.0, 4.0, 0.0));
  positionAlloc->Add (Vector (7.0, 3.0, 0.0));
  positionAlloc->Add (Vector (8.0, 2.0, 0.0));
  positionAlloc->Add (Vector (9.0, 1.0, 0.0));
  ...
  AnimationInterface anim("l8q2.xml");
